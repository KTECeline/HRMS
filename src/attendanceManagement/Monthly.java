...
private void loadAttendanceData(String userId) {
    ...
    private void calculateMetrics() {
        ...
        Calculation calculator = new Calculation(userID);
         ...
         int daysWorked = calculator.calculateDaysWorked();
        int daysLate = calculator.calculateDaysLate();
        int daysOnTime = calculator.calculateDaysOnTime();
        String totalOvertime = calculator.calculateTotalOvertime();
        String totalUndertime = calculator.calculateTotalUndertime();
        String averageClockIn = calculator.calculateAverageClockIn();
